        ...
        stage("env") {
            steps {
                script {
                    ...
                    env.RELEASE_TYPE = (env.JOB_NAME == "mihai-pipeline-test" ? "release" : "ci")
                }
            }
        }
        stage("build-all") {
                ...
                stage("linux") {
                    ...
                    stages {
                        ...
                        stage("checkout") {
                            ...
                            steps {
                                git branch: "${BRANCH_TO_BUILD}", url: "https://github.com/brave/brave-browser.git"
                            }
                        }
                        stage("clean") {
                            when {
